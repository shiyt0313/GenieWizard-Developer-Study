...
Both apps can be ran with the following commands:
```bash
npx expo start --web
```
...
When you click on one of the food items, you can add it to your order.
...
<font color="red">You can try to order a food with your own customization and send it to kitchen.</font>
...
<font color="red">
You can try the app with the following steps:
1. Set the location and date for your trip.
2. Select a hotel and choose a room from the list.
3. Confirm the booking and check the booking history in the profile page.
</font>
